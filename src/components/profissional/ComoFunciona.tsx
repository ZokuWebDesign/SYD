  ...
  return (
    <section id="como-funciona" className="w-full max-w-8xl mx-auto flex flex-col items-center gap-12 py-16 lg:py-28 px-4 lg:px-14">
      <header className="flex flex-col items-center gap-2 w-full lg:w-[48rem] text-center">
        ...
        <p>No SYD, você tem controle total sobre seus atendimentos, horários e ganhos — tudo isso em uma plataforma segura, ética e feita por quem entende a rotina da psicologia.</p>
      </header>
      ...
      <div className="w-full grid gap-8 md:grid-cols-4">
        ...
        <div className="text-center">
          ...
          <h3>Comece a atender<br />agendamentos</h3>
        </div>
        ...
        <div className="text-center">
          ...
          <h3>Acompanhe seus<br />pacientes</h3>
        </div>
