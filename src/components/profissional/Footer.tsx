...
*/}
import { WHATSAPP_LINKS, SOCIAL_LINKS, LEGAL_LINKS, PAGE_LINKS } from "@/constants/links";
            ...
            <div className="space-y-6 w-full md:max-w-[400px] lg:max-w-full">
              ...
              <div className="flex flex-col items-start gap-1 w-full">
                ...
                <div className="flex items-center gap-2 text-secondary">
                  ...
                  <a href={WHATSAPP_LINKS.PROFESSIONAL.CONTACT} target="_blank" rel="noopener noreferrer" className="hover:underline"><p className="text-secondary">+55 15 99694-5695</p></a>
                </div>
                <div className="flex items-center gap-2 text-secondary">
